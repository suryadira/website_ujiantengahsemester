    ...
    <div class="container section">
      ...
      <?php 
        ...
        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
          <div class="block-2">
            <div class="flipper">
              <div class="front" style="background-image: url(admin/images/<?php echo $sql['gambar']?>);">
                <div class="box">
                  <h2><?php echo $sql['nama_staff'] ?></h2>
                  <p><?php echo $sql['level']?></p>
                </div>
              </div>
              <div class="back">
                <!-- back content -->
                <blockquote>
                  <p><?php echo $sql['deskripsi'] ?></p>
                </blockquote>
                <div class="author d-flex">
                  <div class="image mr-3 align-self-center">
                    <img src="admin/images/<?php echo $sql['gambar']?>" alt="">
                  </div>
                  <div class="name align-self-center"><?php echo $sql['nama_staff'] ?> <span class="position"><?php echo $sql['level']?></span></div>
                </div>
              </div>
            </div>
          </div> <!-- .flip-container -->
