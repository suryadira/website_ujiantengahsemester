...
<html>
  <head>
    ...
    <title>Miracle Hotel by Manda.com</title>
    ...
    <header class="site-header js-site-header">
      <div class="container-fluid">
        <div class="row align-items-center">
          <div class="col-6 col-lg-4 site-logo" data-aos="fade"><a href="index.html">Miracle Hotel</a></div>
        ...
        <div class="container">
          <div class="row mb-4">
            ...
            <div class="col-md-3 mb-5 pr-md-5 contact-info">
              ...
              <p><span class="d-block"><span class="ion-ios-location h5 mr-3 text-primary"></span>Address:</span> <span>Jimbaran, Kec. Kuta Sel., <br> Kabupaten Badung, Bali</span></p>
              <p><span class="d-block"><span class="ion-ios-telephone h5 mr-3 text-primary"></span>Phone:</span> <span> (0361) 702222</span></p>
              <p><span class="d-block"><span class="ion-ios-email h5 mr-3 text-primary"></span>Email:</span> <span> info@miracle-hotel.com</span></p>
            </div>
            <div class="col-md-3 mb-5">
          ...
          <div class="row pt-5">
            <p class="col-md-6 text-left">
              <!-- Link back to Manda can't be removed. Template is licensed under CC BY 3.0. -->
              Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart-o" aria-hidden="true"></i> by <a href="https://Manda.com" target="_blank" >Manda</a>
              <!-- Link back to Manda can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
